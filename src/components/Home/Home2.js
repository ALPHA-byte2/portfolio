        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I fell in love with programming and i can develop a perfect, functional, user friendly websites and applications
              <br />
              <br />I am fluent in classics like
              <i>
                <b className="purple"> C++,Javascript,React, php etc. </b>
              </i>
              <br />
              <br />
